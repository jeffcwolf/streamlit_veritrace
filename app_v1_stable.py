"""This is a stable version but it needs improvement:

1. Implement search bar
2. Make it load faster
3. Remove user width control
4. Improve styling of the Dataframe
5. Any other visualisations?
6. Provide text introduction
7. Per data source, print the number of records by language (improve metadata)
8. Make everything look a bit nicer, if possible
